        ...
        with os.scandir(path) as files:
            ...
            for entry in files:
                ...
                if entry.is_dir():
                    ...
                    ListPath.append(str(entry.path))
                    ListName.append(os.path.basename(entry.path))
    except:#输入的是文件路径时：
        ListPath.append(str(path))
        ListName.append(os.path.basename(path))
...
def PrintOn(InputPath,ListPath,ListName,DisplayName,DisplayPath):
    str = ''
